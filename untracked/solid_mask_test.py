...
parser.add_argument('--num_pixels_blank', default=0, type = int)
    ...
    for prompt in prompt_list:
        ...
        for extend_prompt in [True]:
            ...
            if (args.use_pregenerated):
                ...
                # 
                # FOR THE PURPOSES OF THIS TEST, USE THE LAST IMAGE
            ...
            for inpainter_choice in args.inpainter:
                ...
                for inpainting_iteration in range(num_inpainting_iterations):
                    ...
                    if args.solid_mask:
                        mask_array[:args.num_pixels_blank, :args.num_pixels_blank] = 0
