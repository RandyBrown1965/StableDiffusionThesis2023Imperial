...
#
# Run it three times; optimized, random mask, and soid mask
# then copy the original into the same directory
# to make a foursome for human evaluations.
#
import argparse
import os
import shutil
...
parser.add_argument('--num_inpainting_iterations', default=1, type = int)
...
output_dir = "images_out_ThesisPaper_" + args.use_pregenerated_dir.split("_")[-1]
...
for image_pathname in list_of_test_pathnames:
    ...
    for i in range(10):
        ...
        os.system("python sd_sdxl_imagegen_inpaint_constantthreshold.py  --images_per_prompt " + str(args.images_per_prompt)\
