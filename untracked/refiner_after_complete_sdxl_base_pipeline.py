...
#
# THIS IS HARDCODED TO USE THE INPAINTER AFTER COMPLETE GENERATION BY SDXL-BASE, BUT denoising_start IS SET-ABLE
#
import argparse
import os
...
parser.add_argument('--denoising_start', default=0.8)
                ...
                if use_refiner:
                    ...
                    for i in range(len(images_gen)):
                        ...
                        image_refiner = refiner(prompt=prompt_total, image=image_gen[None, :],
                                ...
                                denoising_start=float(args.denoising_start),
                                ).images[0]
