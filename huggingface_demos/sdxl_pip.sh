...
echo "source ~/venv/sdxlstylegan3venv_pip2/bin/activate"
source ~/venv/sdxlstylegan3venv_pip2/bin/activate

echo "python ~/Thesis/sdxl_inpaint.py"
python ~/Thesis/sdxl_inpaint.py
#echo "python ~/Thesis/sdxl_refiner.py"
#python ~/Thesis/sdxl_refiner.py
echo "python ~/Thesis/sdxl_refiner2.py"
python ~/Thesis/sdxl_refiner2.py
echo "python ~/Thesis/sdxl_refiner_ensemble.py"
